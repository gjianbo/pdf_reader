...
extension CategoryQueryLinks
    on QueryBuilder<Category, Category, QFilterCondition> {
  QueryBuilder<Category, Category, QAfterFilterCondition> books(
      FilterQuery<Book> q) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> booksLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> booksIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'books', 0, true, 0, true);
    });
  }

  QueryBuilder<Category, Category, QAfterFilterCondition> booksIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'books', 0, false, 999999, true);
    });
  }

  QueryBuilder<Category, Category, QAfterFilterCondition> booksLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> booksLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
